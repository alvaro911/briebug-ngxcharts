...
@Component({
  selector: 'app-local-charts',
  providers: [Location, {provide: LocationStrategy, useClass: HashLocationStrategy}],
  templateUrl: './local-charts.component.html',
  styleUrls: ['./local-charts.component.css']
})
export class LocalChartsComponent implements OnInit {
